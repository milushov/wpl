...
gem 'rails', '3.2.3'
gem 'haml_coffee_assets' # moved from assets block, because this https://github.com/netzpirat/haml_coffee_assets/issues/59
gem 'jquery-rails'
gem 'heroku'
gem 'thin'
gem 'mongoid', '~> 2.4'
...
gem 'omniauth-vkontakte', git: 'git://github.com/milushov/omniauth-vkontakte'
